...
const firstChoice = document.getElementById("firstChoice")
  ...
  const url2 = 'https://genius-song-lyrics1.p.rapidapi.com/chart/songs/?time_period=all_time&per_page=50&page=2';
...
const url = `https://genius-song-lyrics1.p.rapidapi.com/chart/${par1}/?time_period=all_time&per_page=50&page=1`;
const url2 = `https://genius-song-lyrics1.p.rapidapi.com/chart/${par1}/?time_period=all_time&per_page=50&page=2`;
  try {
    const response = await fetch(url, options);
    const response2 = await fetch(url2,options);
    const result1 = await response.json();
